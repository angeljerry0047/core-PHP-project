...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><blockquote>
   <p class="ml">The <b>Man Research Info</b> section is designed to provide
   vital analysis information such as market trends and analysis on certain
   commodities.<br><br>
   The following report is: The Optima Report</p>
   <p class="sl">
   <script language="JavaScript" src="http://man.barchart.com/pl/man/dreports.htx?name=optima">
   </script>
   </p><br>
   </blockquote>
   </td>
