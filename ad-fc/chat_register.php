...
";
             ...
             //@SendEmail("{$useremail}",              "New Registration", "$send", "register@ad-financial.com");
             @SendEmail("adaoud@ad-financial.com", "ADFC trial period Request", "$send", "adaoud@ad-fc.net");
   ...
   $inBody = "<form action='chat_register.php' method=post><input type='hidden' name='action' value='register'>
                ...
                <tr bgcolor='#b4b4b4'> 
                  <td width='429' bgcolor='#666666' > 
                    <table width='100%' border='0' cellspacing='1' cellpadding='5' height='78' bgcolor='#f5f5f5' class=copy2>
                      ...
                      <tr> 
                        <td>&nbsp;</td>
                        <td><a href='chat_login.php'>Login</a></td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
