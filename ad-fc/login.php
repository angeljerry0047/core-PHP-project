<?php
    ...
    if ($action=="login")
   {
       ...
       $sql = "select * from finance_users where username='$username' and ppw='$ppw' and approve='1' and is_blocked<>'yes' ";
       $result = @mysql_query( $sql );
        if( $result){
            ...
            if (!$err)
            {
              ...
              Header ("Location: member_area.html");
              exit;
            }
        }else{
            SaveError ("Can't get query ". mysql_errno().": ".mysql_error()."(login.php '1').<br>");  
...
A:hover {color:#FF6600; font-family: Helvetica, Arial; font-size: 14px; text-decoration: underline;}
...
<tr> 
      ...
      <TD width="654" valign="top" bgcolor="F8FBFE"> 
       <!-- <table width="100%" border="0" cellspacing="2" cellpadding="2" height="65" class=blackred bgcolor='#AEE4FF'>-->
       <table width="100%" border="0" cellspacing="2" cellpadding="2" height="65" >
          <tr> 
            <td valign="top" height="31"><font color="#003366" size="2"><b>Please
              log in to view this page:</b></font><br><font color=red><b><?php echo $bad1; ?></b></font>
              <form method="POST" action="login.php"><input type='hidden' name='action' value='login'>
                <div align="center">
                  <center>
              ...
              <p>If you are not a client, please <a href="contact.html"><font size="2">register 
                <font size="2"></font></font></a> to get a free trial<a href="contact.html"></a>.</td>
          </tr>
        </table>
      </TD>
