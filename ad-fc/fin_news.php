...
<tr> 
            ...
            <tr> 
              <td valign="middle" background="http://www.adfinancial.com/images/cell_bg_resources.gif" width="143" height="14"> 
                <div align="right">
                  <p align="left"><font color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
//$file = fopen ("http://www.fxstreet.com/nou/noticies/afx/noticiasAll.asp", "r");
$file = fopen ("http://www.fxstreet.com/news/forex-news/default.aspx", "r");
...
else
{
  ...
  $pos = strpos ($sResponse, '<!-- INICIO ENGINY NEWS -->');
  $sResponse = substr ($sResponse, $pos );
//  $pos = strpos ($sResponse, '<table width="100%" border="0" cellspacing="0" cellpadding="2" valign="top">');
//  $sResponse = substr ($sResponse, $pos);
  $pos = strpos ($sResponse, '<form id="News1-myform" method="POST">');
  $sResponse = substr ($sResponse, 0, $pos);
  $sResponse .= "</table>";
  $sResponse = str_replace ('src="/', 'src="http://www.fxstreet.com/', $sResponse);
  $sResponse = str_replace ('href="./', 'target="_blank" href="http://www.fxstreet.com/news/forex-news/', $sResponse);
//  $sResponse = preg_replace ('|<td class="taulatexte" colspan="2" align="center">[\s\S]*?</td>|i', '<td colspan="2"></td>', $sResponse);
