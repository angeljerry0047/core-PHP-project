...
";
          ...
          @SendEmail("{$row['email']}", "Restore Password Email", "$send", "register@ad-financial.com");
   ...
   $inBody = "<form action='chat_forgot.php' method=post><input type='hidden' name='action' value='restore'>
                  ...
                  <td>
                    <table width='100%' border='0' cellspacing='1' cellpadding='5' height='78' class=copy2 bgcolor='#f5f5f5'>
                      ...
                      <tr> 
                        ...
                        <td> 
                          <input type='text' name='email' size='50' maxlength='50' value='{$user['email']}'>
                        </td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
