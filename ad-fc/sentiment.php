...
$file = fopen ("http://www.vtoreport.com/sentiment/sentiment.htm", "r");
if (!$file) {
    echo "<p></p>\r\n";
}
else
{
  ...
  $pos = strpos ($sResponse, '<div align="center"><center>');
  $sResponse = substr ($sResponse, $pos + 1);
  $pos = strpos ($sResponse, '<div align="center"><center>');
  $sResponse = substr ($sResponse, $pos);
  $pos = strpos ($sResponse, 'Source: Investors Intelligence');
  $sResponse = substr ($sResponse, 0, $pos);
  $sResponse .= "</tr></table></center></div>";
  $sResponse = str_replace ('src="../', 'src="http://www.vtoreport.com/', $sResponse);
