...
<HTML>
<HEAD>
<TITLE>AD Financial: USDA Reports</TITLE>
...
<!--LINK href="http://www.nass.usda.gov/scripts/css/usdastyle.css" rel="stylesheet" type="text/css"-->
...
$file = fopen ("http://www.nass.usda.gov/Publications/Reports_By_Date/index.asp", "r");
if (!$file) {
    echo "<p></p>\r\n";
}
else
{
  ...
  $pos = strpos ($sResponse, '<table width="368" border="0" align="left" cellpadding="0" cellspacing="0">');
  $sResponse = substr ($sResponse, $pos);
  $pos = strpos ($sResponse, 'class="HdrBoldBlue">&nbsp;</td>');
  $sResponse = substr ($sResponse, 0, $pos);
  $sResponse .= "class=\"HdrBoldBlue\">&nbsp;</td></tr></table>";
  $sResponse = str_replace ('href="/', ' target="_blank" href="http://www.nass.usda.gov/', $sResponse);
  $sResponse = str_replace ('src="/', 'src="http://www.nass.usda.gov/', $sResponse);
