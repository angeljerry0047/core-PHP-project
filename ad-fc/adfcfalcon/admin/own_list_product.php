...
if(isset($_GET['action']) && $_GET['action']=='delete')
{
	...
	$_SESSION['msg']=message('One product has been deleted sucessfully',1);
...
$q="select * from one_way_product a where a.name<>'' order by `id` ASC";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td align="left" class="body_title_style" bgcolor="<?php echo $color?>">Product List </td>
...
<tr><td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr class="<?php echo $flag%2==0?"alternate_color1":"alternate_color2";?>">
    <?php 
	  ...
	  ?>
	  <td width="6%" align="center" class="light_text_bold">Code</td>
	<td width="12%" align="center" class="light_text_bold">Name </td>
	<td width="12%" align="center" class="light_text_bold">Arabic Code </td>
	<td width="13%" align="center" class="light_text_bold">Arabic Name </td>
	<td width="39%" align="center" class="light_text_bold">Description</td>
	
	<td width="18%" align="center" class="light_text_bold">Option</td>
  </tr>
  <?php
...
?>
  <tr class="<?php echo ++$flag%2==0?"alternate_color1":"alternate_color2";?>" onclick="javascript:location.href='#response.php?mid=<?php echo $row->color_id;?>';" onmouseover="this.className='hover_color'" onmouseout="this.className='<?php echo $flag%2==0?"alternate_color1":"alternate_color2";?>'">
   <td class="light_text"><p style="padding-left:5px;"><?php echo ($row->code);?>&nbsp;
</p></td>
   <td class="light_text"><p style="padding-left:5px;"><?php echo ($row->name);?>&nbsp;
</p></td>
   <td class="light_text" dir="rtl"><span style="padding-left:5px;"><?php echo ($row->acode);?></span></td>
   <td class="light_text" dir="rtl"><span style="padding-left:5px;"><?php echo ($row->aname);?></span></td>
   <td class="light_text"><p style="padding-left:5px;"><?php echo ($row->details);?>&nbsp;
</p></td>

    
    <td colspan="4" align="center" class="light_text" width="18%">&nbsp;
 <input name="button" type="button" class="butt1" style="background:<?php echo $color?>"  onclick="window.location.href='owm_add_product.php?game_id=<?php echo $row->id; ?>&action=edit'" value="Edit" />
&nbsp;
