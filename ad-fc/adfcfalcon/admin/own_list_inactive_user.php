...
//-----------------------------------Generate Sql----------------------
	...
	$sql="select * from one_way_user a where a.name<>'' and a.id <>1 and a.status='inactive' and account_type='".$t."' order by `user_id` ASC";
...
function show()
{
 ...
 <script language="javascript">
   function del(aa)
   {
      ...
      if (a)
      {
        location.href="own_list_inactive_user.php?cid="+ aa +"&action=delete&t=<?php echo $t?>&u=<?php echo $u?>"
      }  
   } 
   function inactive(aa)
   {
     var a=confirm("Are you sure, you want to Active this user?")
      if (a)
      {
       location.href="own_list_inactive_user.php?cid="+ aa +"&action=inactive&t=<?php echo $t?>&u=<?php echo $u?>"
	  }
   ...
   function active(aa)
   {
      ...
      if (a)
      {
       ...
       location.href="own_list_inactive_user.php?cid="+ aa +"&action=active&t=<?php echo $t?>&u=<?php echo $u?>"
	  }
...
<tr><td><table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr class="<?php echo $flag%2==0?"alternate_color1":"alternate_color2";?>">
	...
	<td width="13%" align="center" class="light_text_bold">Password </td>
