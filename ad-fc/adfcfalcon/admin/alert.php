...
<tr>
<td height="50" align="center" valign="middle" class="normal_text_bold"><?php echo "Date : ".$dt; ?></td>
   ...
   $date1=$row->date1;
         ...
         if($row->status=="trial")
		 {
				  ...
				  // echo $sdate." ".$tdate." ".$date1."-T<br>";
				   ...
				   echo "<tr>
<td height='50' align='center' valign='middle' class='normal_text_bold'>Name : ".$row->user_id ." - Expire Date : ".$date1." - Trial</td></tr>
";
	     ...
	     if($row->status=="active")
		 {
				 ...
				 // echo $sdate." ".$tdate." ".$date1."-S<br>";
				  echo "<tr>
<td height='50' align='center' valign='middle' class='normal_text_bold'>Name : ".$row->user_id ." - Expire Date : ".$date1." - Subscription</td></tr>
";
