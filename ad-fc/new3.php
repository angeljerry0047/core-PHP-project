...
$file = fopen ("http://charts.futuresource.com/cis/fscom?cont=gec1%21&period=V&varminutes=15&size=150x150&bartype=AREA&bardensity=MEDIUM&headerbackground=(221,221,221)&headerforeground=(102,102,102)&headerdatacolor=(0,1,125)&studyheaderbackground=(221,221,221)&showextendednames=true&random={$rand}", "r");
if ($file) {
