...
";
             ...
             @SendEmail("register@ad-fc.net", "ADFC trial period Request", "$send", "register@ad-fc.net");
   ...
   $inBody = "<form action='admin_register.php' method=post><input type='hidden' name='action' value='register'>
